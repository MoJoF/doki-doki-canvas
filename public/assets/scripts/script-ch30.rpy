...
label ch30_14:
    ...
    m "Хотя, если подумать, то это весьма заманчиво... Ysg0LjRgdC60LDQu9C4INGG0LXQu9GMIC0g0L3QviDQvtCx0L3QsNGA0YPQttC40LvQuCDQu9C40YjRjC"
...
label ch30_29:
    ...
    m "Даже не то что 'заводить друзей', скорее знакомиться."
