...
label ch5_main:
    ...
    "Это моя вина--!"
    "Мои мысли копошились, показывая мне всё, что я мог сделать, чтобы предотвратить это."
