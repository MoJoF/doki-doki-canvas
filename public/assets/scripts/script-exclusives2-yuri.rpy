...
label yuri_exclusive2_2_ch22:
    ...
    "{cps=150}Я заглядываю за угол.{/cps}{nw}"
    "{cps=150}Кому-то больно?..{/cps}{nw}"
    "{cps=150}Долгий вздох, словно сквозь зубы.{/cps}{nw}"
    y "{cps=150}Кхххххх--{/cps}{nw}"
    "{cps=150}Звучит как дыхание.{/cps}{nw}"
    "{cps=150}Прямо за углом...{/cps}{nw}"
    "{cps=150}...Что это за звуки?{/cps}{nw}"
    y "{cps=150}... Хаах... хаах...{/cps}{nw}"
    y "{cps=150}Хаах... хаах...{/cps}{nw}"
    $ y_name = "Юри"
    "{cps=150}Я продолжаю идти по корридору.{/cps}{nw}"
    "{cps=150}Логично будет поискать Юри у ближайшего фонтанчика с водой...{/cps}{nw}"
    mc "{cps=150}Так, посмотрим...{/cps}{nw}"
    window hide(None)
    window auto
    scene bg club_day
    show noise zorder 100 at noise_alpha
    show vignette zorder 100 at vignetteflicker(-2.030)
    show layer master at rewind
    "{cps=150}Я заскучал и поэтому решил пойти поискать её.{/cps}{nw}"
    "{cps=150}Что-то она задерживается...{/cps}{nw}"
    "{cps=150}Юри сказала, что это не займет много времени...{/cps}{nw}"
